...
export default {
    ...
    methods: {
        ...
        handledelete(index, row) {
                    ...
                    this.$axios.get('/teacherDeleteLog',{
							params: {
                                id:row.id
							},headers: {
                                "token":localStorage.getItem("token"),
         ...
         handlesee(index, row) {
                ...
                this.$router.push('/checkstulog?id='+row.id)
        },
         ...
         handleup(index, row) {
                    ...
                    this.$axios.get('/teacherReductLog',{
							params: {
                                id:row.id
							},headers: {
                                "token":localStorage.getItem("token"),
        ...
        getData() {
            ...
            if(this.checked == false){
                  ...
                  this.$axios.get('/teacherListDeletedLog',{
							params: {
                                    studentId: this.$route.query.id,
                                    pageIndex: this.query.pageIndex-1,
                                    pageSize: this.query.pageSize
