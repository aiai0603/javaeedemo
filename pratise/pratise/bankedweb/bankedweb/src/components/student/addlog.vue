            ...
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="100px">
                    <el-form-item label="日志标题">
                          <el-input v-model="form.logTitle"  placeholder="请输入标题(例如，第一周日志)"></el-input>  
                    </el-form-item>
                    <el-form-item label="日志内容">
                        <el-input type="textarea" autosize placeholder="请输入内容,不少于200字" v-model="form.studentLog"> </el-input>
                    </el-form-item>
